...
export const NAV = {
  ...
  pmu: [
    ...
    { icon: 'doc', label: 'Survey', path: '/gt/pmu/list/surveys', overline: 'Content · DIA', title: 'DIA Survey' },
    { icon: 'personAdd', label: 'BDSP Onboarding', path: '/gt/pmu/list/bdsp', overline: 'Content · DIA', title: 'BDSP Onboarding' },
    { icon: 'doc', label: 'E-learning Module', path: '/gt/pmu/list/elearning-module-content', overline: 'Content · DIA', title: 'E-learning Module' },
    { icon: 'personAdd', label: 'PBSP Onboarding', path: '/gt/pmu/list/bds-service-providers-onboarding', overline: 'Content · DIA', title: 'Panel BDS Provider (PBSP) Onboarding' },
    { icon: 'inbox', label: 'Bulk Broadcast', path: '/gt/pmu/list/bulk-broadcast', overline: 'Content · DIA', title: 'Bulk Broadcast' },
    { icon: 'groups', label: 'Discussion Forum', path: '/gt/pmu/list/discussion-forum', overline: 'Content · DIA', title: 'Discussion Forum' },
    { icon: 'doc', label: 'Latest Developments', path: '/gt/pmu/list/latest-developments', overline: 'Content · DIA', title: 'Latest Developments' },
    { icon: 'doc', label: 'Pop-Ups', path: '/gt/pmu/list/pop-ups', overline: 'Content · DIA', title: 'Pop-Ups' },
  ],
  ia: [
