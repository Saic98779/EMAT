...
import { toFormValues, stageOf } from '../../apis/disbursementCapacityBuilding'

// GT Field Manager — capacity building event review queue.
// GT's job on one of these notes is row 12 of the format: comments on how the
// event was organised and what it achieved. Nothing else on the note is
// theirs to edit.
export default function GtCapacityBuildingReview() {
  ...
  return (
    <Box>
      <PageHeader
        title="Capacity Building — Event Review"
                ...
                <TableRow>
                  <TableCell colSpan={5} align="center" sx={{ py: 6 }}>
                    <Typography color="text.secondary">
                      {q ? `No notes match “${q}”.` : 'No capacity building notes awaiting comments.'}
                    </Typography>
                  </TableCell>
                </TableRow>
              )}
  ...
  return (
    <Box sx={{ p: 2.5 }}>
      <Stack spacing={2}>
        ...
        <SubCard title="GT — Event Organisation, Outcome & Impact" accent="primary">
          <TextField
